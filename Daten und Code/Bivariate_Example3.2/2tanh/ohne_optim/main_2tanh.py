...
rng = np.random.RandomState(264)#264
...
class Bivariate(object):
    ...
    def optimal_int(self, num_interv, interv_x, interv_y):
        ...
        for t in range(num_interv):
            ...
            #plt.ylabel("Negative Information Gain")
           # _ = plt.title("Objective for $do(X_2=x_2^2)$")
            #plt.show()
            """
...
#sigma_x2_g1 = np.sqrt(0.7)

gamma_g2 = 1.75
sigma_x1_g2 = 1
sigma_x2_g2 = np.sqrt(0.1)
#sigma_x2_g2 = np.sqrt(0.7)

sigma_x1_g3 = 1
sigma_x2_g3 = np.sqrt(0.1)
#sigma_x2_g3 = np.sqrt(0.7)
