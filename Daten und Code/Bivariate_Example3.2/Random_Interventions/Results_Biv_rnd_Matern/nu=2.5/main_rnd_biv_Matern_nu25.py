...
def pobD_givenG(X, Y, gamma, sigma_x, sigma_y):
    ...
    kernel = ConstantKernel(1.0, constant_value_bounds="fixed") * Matern(length_scale=gamma, length_scale_bounds="fixed", nu=2.5)
...
k = ConstantKernel(1.0, constant_value_bounds="fixed") * Matern(length_scale=gamma_g1, length_scale_bounds="fixed", nu=2.5)
...
"""
k2 = ConstantKernel(1.0, constant_value_bounds="fixed") * Matern(length_scale=gamma_g2, length_scale_bounds="fixed", nu=2.5)
